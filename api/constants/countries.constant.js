...
const countries = countriesStates.map(v => v.country);
const getCountryStates = country => {
  const countryStates = countriesStates.filter(v => v.country === country);
  if (countryStates.length != 0) return countryStates[0].states;
  else return [];
};

module.exports = { countries, getCountryStates };
