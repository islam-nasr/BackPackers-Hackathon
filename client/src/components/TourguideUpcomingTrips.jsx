...
export default class TourguideUpcomingTrips extends Component {
  constructor(props) {
    super(props);
    this.state = {
      trips: [],
  ...
  componentDidMount() {
    axios
      ...
      .then(res => {
        this.setState({ trips: res.data.data, loaded: true });
      })
      .catch(error => {
        alert(error.message);
      });
  ...
  render() {
    if (!this.state.loaded) return <dev />;
    return (
      <div>
        <div class="back">
          <TopNavbar />
          <div class="container pt-5">
            <h1 class="my-4">Upcoming Trips</h1>
            {this.state.trips
              .filter(trip => {
                return (
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      ...
                      <p>
                        ...
                        <br />
                        Price: {trip.averagePrice}
                      </p>
                      <a class="btn btn-primary" href={"/tourist/UpcomingTrip"}>
                        View details
                      </a>
                    </div>
                  </div>
